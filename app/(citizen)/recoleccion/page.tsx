...
export default function RecoleccionPage() {
  ...
  useEffect(() => {
    ...
    api.get<CollectionSchedule[]>(`/schedules?zoneId=${zoneId}`)
      .then(setSchedules)
      ...
      <div className="max-w-xl mx-auto">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-on-surface-variant text-sm font-bold">No tienes una zona asignada</p>
          </div>
        ) : schedules.length === 0 ? (
          <div className="text-center py-12">
            <span className="material-symbols-outlined text-3xl text-outline block mb-2">schedule</span>
            <p className="text-on-surface-variant text-sm font-bold">No hay horarios disponibles para tu zona</p>
          </div>
        ) : (
