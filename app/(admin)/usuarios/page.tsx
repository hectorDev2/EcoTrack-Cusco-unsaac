...
export default function UsuariosPage() {
  return (
    <div className="flex flex-col min-h-screen bg-surface">
      <header className="bg-surface border-b border-outline-variant shadow-sm flex justify-between items-center w-full px-lg py-md sticky top-0 z-10">
        <div className="flex items-center gap-lg flex-1">
          ...
          <div className="max-w-md w-full relative">
            ...
            <input
              className="w-full bg-surface-container-low border-none rounded-full py-sm pl-10 pr-md text-[14px] leading-[20px] focus:ring-2 focus:ring-primary"
      ...
      <div className="p-lg overflow-auto flex-1">
        <div className="max-w-[1440px] mx-auto space-y-lg">
          <div className="flex justify-between items-end">
            ...
            <button className="bg-primary text-on-primary px-lg py-md rounded-lg text-[12px] leading-[16px] tracking-[0.05em] font-bold flex items-center gap-sm hover:shadow-md transition-shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-md">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="bg-surface-card p-md rounded-xl shadow-sm border border-outline-variant flex items-center gap-md"
              >
            ...
            <div className="flex-1 bg-surface-card rounded-xl shadow-sm border border-outline-variant overflow-hidden flex flex-col">
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-surface-container-low border-b border-outline-variant">
                      <th className="px-lg py-md text-[12px] leading-[16px] tracking-[0.05em] font-bold text-on-surface-variant uppercase">Nombre</th>
                      <th className="px-lg py-md text-[12px] leading-[16px] tracking-[0.05em] font-bold text-on-surface-variant uppercase">Email</th>
                      <th className="px-lg py-md text-[12px] leading-[16px] tracking-[0.05em] font-bold text-on-surface-variant uppercase">Rol</th>
                      <th className="px-lg py-md text-[12px] leading-[16px] tracking-[0.05em] font-bold text-on-surface-variant uppercase">Zona</th>
                      <th className="px-lg py-md text-[12px] leading-[16px] tracking-[0.05em] font-bold text-on-surface-variant uppercase">Estado</th>
                      <th className="px-lg py-md text-[12px] leading-[16px] tracking-[0.05em] font-bold text-on-surface-variant uppercase text-right">Acciones</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-outline-variant">
                    {users.map((user) => (
                      ...
                      >
                        ...
                        <td className="px-lg py-md text-on-surface-variant text-[14px] leading-[20px]">
                          {user.email}
                        </td>
                        <td className="px-lg py-md">
                        ...
                        <td className="px-lg py-md text-[14px] leading-[20px] text-on-surface-variant">
                          {user.zone}
                        </td>
                        <td className="px-lg py-md">
                          <div className={`flex items-center gap-xs ${user.active ? "text-waste-organic" : "text-waste-non-recyclable"}`}>
              ...
              <div className="bg-surface-container-low px-lg py-md flex items-center justify-between border-t border-outline-variant">
                ...
                <div className="flex items-center gap-sm">
                  <button className="p-sm rounded-lg hover:bg-surface-container-high text-outline transition-colors disabled:opacity-30">
                  ...
                  <button className="p-sm rounded-lg hover:bg-surface-container-high text-outline transition-colors">
      ...
      <footer className="w-full py-lg px-xl flex justify-between items-center max-w-[1440px] mx-auto bg-surface-container border-t border-outline-variant">
        ...
        <div className="flex gap-lg">
          ...
          <a className="text-[14px] leading-[20px] text-on-surface-variant hover:text-primary transition-colors flex items-center gap-xs" href="#">
